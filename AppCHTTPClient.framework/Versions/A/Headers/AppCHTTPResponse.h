...
typedef enum {
    AppCHTTPResponseStateUnsent = 0,
    AppCHTTPResponseStateOpened = 1,
    AppCHTTPResponseStateHeaders = 2,
    AppCHTTPResponseStateLoading = 3,
    AppCHTTPResponseStateDone = 4
} AppCHTTPResponseState;

@interface AppCHTTPResponse : NSObject
{
    NSMutableData *_data;
}
...
@property(nonatomic) AppCHTTPResponseState readyState;
