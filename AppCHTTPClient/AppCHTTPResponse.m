...
@implementation AppCHTTPResponse
...
-(void)setResponse:(NSURLResponse*) response
{
    ...
    if([response isKindOfClass:[NSHTTPURLResponse class]]) {
        ...
        NSStringEncoding encoding = [AppCHTTPHelper parseStringEncodingFromHeaders: _headers];
...
-(NSString*)responseString
{
    ...
    if (result==nil) {
        ...
        BOOL didExtractEncoding =  [AppCHTTPHelper extractEncodingFromData:data result:&encoding];
